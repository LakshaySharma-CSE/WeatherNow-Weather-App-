...
WeatherNow is a clean, fast, and simple weather application built with HTML, CSS, and JavaScript.  
It includes live weather search, city auto-suggestions using OpenWeather Geo API, GPS-based weather, and a modern iOS-inspired UI.

---

## 🛠 Features
- 🌍 Live weather search  
- 🔎 Auto-suggested city names  
...
- OpenWeather Weather API (Current weather)  
- OpenWeather Forecast API (5-day forecast)
